 ...
 * @returns
 */
export const Get = <T>(url: string, params: IAnyObj = {}, clearFn?: Fn): ApiResponse<T> =>
  new Promise((resolve) => {
    instance
      .get(url, { params })
      .then((result) => {
 ...
 * @returns
 */
export const Put = <T>(url: string, data: IAnyObj, params: IAnyObj = {}): ApiResponse<T> => {
  return new Promise((resolve) => {
    instance
      .put(url, data, { params })
      .then((result) => {
 ...
 * @returns
 */
export const Delete = <T>(url: string, params: IAnyObj = {}, clearFn?: Fn): ApiResponse<T> =>
  new Promise((resolve) => {
    instance
      .delete(url, { params })
      .then((result) => {
